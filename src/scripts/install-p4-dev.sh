...
## Source: https://github.com/nsg-ethz/p4-utils/blob/83b118bbae530b31cc74e7fa32f9174f7c0a1184/install-tools/install-p4-dev.sh
## - Modified to use fixed p4-utils GitHub commit "P4_UTILS_COMMIT"/"P4_LEARNING_COMMIT"
## - Replace "libgc1c2" by "libgc1" for Ubuntu 22.04
...
P4_LEARNING_COMMIT="0ddba187f207e24a8a614f5d1abf8bc11998c9d3"
...
function do_global_setup {
    ...
    # Configure tmux
    wget -O ~/.tmux.conf https://raw.githubusercontent.com/nsg-ethz/p4-utils/${P4_UTILS_COMMIT}/install-tools/conf_files/tmux.conf
}
...
PY3LOCALPATH=`curl -sSL https://raw.githubusercontent.com/nsg-ethz/p4-utils/${P4_UTILS_COMMIT}/install-tools/scripts/py3localpath.py | python3`
...
function do_mininet_no_python2 {
    ...
    # patching mininet
    wget -O mininet.patch https://raw.githubusercontent.com/nsg-ethz/p4-utils/${P4_UTILS_COMMIT}/install-tools/conf_files/mininet.patch
...
function do_p4-learning {
    ...
    # TODO: should be removed
    git checkout ${P4_LEARNING_COMMIT}
}
...
function google_module_fix {
    curl -sSL https://raw.githubusercontent.com/nsg-ethz/p4-utils/${P4_UTILS_COMMIT}/install-tools/scripts/protoinitfix.py | sudo python3
}
